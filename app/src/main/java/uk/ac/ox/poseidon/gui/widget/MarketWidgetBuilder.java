...
public class MarketWidgetBuilder implements WidgetBuilder<JComponent, SwingMetawidget> {
    ...
    public JComponent buildWidget(String elementName, Map<String, String> attributes, SwingMetawidget metawidget) {
        ...
        if (actualClass == null || !MarketMap.class.isAssignableFrom(actualClass)) return null;
        ...
        try {
            ...
            MarketMap marketMap = ((MarketMap) PropertyUtils.getProperty(metawidget.getToInspect(), address));
