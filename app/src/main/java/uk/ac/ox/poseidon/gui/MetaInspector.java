...
import uk.ac.ox.poseidon.gui.widget.*;
...
public class MetaInspector extends Inspector {
    ...
    public static void STANDARD_WIDGET_SETUP(SwingMetawidget widget, FishGUI toSyncAgainst) {
        ...
        if (toSyncAgainst != null) {
            CompositeWidgetBuilder<JComponent, SwingMetawidget> composite =
                    new CompositeWidgetBuilder<>(new CompositeWidgetBuilderConfig<JComponent, SwingMetawidget>()
                            .setWidgetBuilders(
